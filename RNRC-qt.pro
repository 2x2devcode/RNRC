...
CONFIG += thread
CONFIG += c++17
QMAKE_CXXFLAGS += -std=c++17 -Wno-deprecated-declarations -Wno-deprecated-copy
...
# Default stack for main + NewThread(stack=0) workers (first PoS IBD).
win32:QMAKE_LFLAGS += -Wl,--stack,33554432
